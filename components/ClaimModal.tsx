...
export default function ClaimModal({ isOpen, onClose, cemeteryName, cemeterySlug }: ClaimModalProps) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    maxLength={6}
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all text-center text-2xl tracking-widest font-mono"
                  />
                </div>
              </div>
