    ...
    return (
      <div className={`bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center ${className}`} style={style}>
        <div className="max-w-sm mx-auto">
          ...
          <p className="text-sm text-gray-600 font-medium mb-2">Advertentieruimte</p>
          <p className="text-xs text-gray-500">
            Accepteer advertentiecookies om relevante advertenties te zien
          </p>
        </div>
      </div>
    );
  ...
  if (adError) {
    return (
      <div className={`bg-gray-50 rounded-lg p-4 text-center ${className}`} style={style}>
        <p className="text-xs text-gray-400">Advertentie kon niet worden geladen</p>
      </div>
    );
  }
