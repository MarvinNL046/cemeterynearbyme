...
const blogImages: Record<string, { searchTerm: string; filename: string }> = {
  'gids-voor-het-kiezen-van-een-begraafplaats': {
    searchTerm: 'peaceful cemetery nature path',
    filename: 'choosing-cemetery-guide.jpg'
  },
  'geschiedenis-nederlandse-begraafplaatsen': {
    searchTerm: 'historic old cemetery gravestones',
    filename: 'historic-cemetery.jpg'
  }
};

// Curated Unsplash image IDs voor begraafplaats-gerelateerde onderwerpen
const curatedImages: Record<string, string[]> = {
  cemetery: [
    'photo-1507003211169-0a1dd7228f2d', // Peaceful cemetery
    'photo-1515255384510-23e8b6a6ca3c', // Historic gravestones
    'photo-1509128841709-6c13b25058a3', // Old cemetery
    'photo-1566438480900-0609be27a4be', // Memorial stones
    'photo-1604014237800-1c9102c219da', // Garden cemetery
  ],
  nature: [
  ...
  historic: [
    'photo-1515255384510-23e8b6a6ca3c', // Historic gravestones
    'photo-1582653291997-079a1c04e5a1', // Old church
    'photo-1590362891991-f776e747a588', // Historic monument
  ]
};
...
async function main() {
  ...
  const downloads = [
    { photoId: 'photo-1507003211169-0a1dd7228f2d', filename: 'choosing-cemetery-guide.jpg' },
    { photoId: 'photo-1515255384510-23e8b6a6ca3c', filename: 'historic-cemetery.jpg' },
  ];
