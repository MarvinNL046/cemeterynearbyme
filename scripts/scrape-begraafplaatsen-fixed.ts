...
function extractStructuredData(
  ...
  return {
    ...
    searchQuery: `${begraafplaats.naam_begraafplaats} ${begraafplaats.gemeente} begraafplaats`,
    websiteData: {
...
async function processBegraafplaats(
  ...
  try {
    ...
    if (genericNames.includes(begraafplaats.naam_begraafplaats.toLowerCase().trim())) {
      console.log(chalk.yellow(`\n⚠️  Skipping generic name: ${begraafplaats.naam_begraafplaats} in ${begraafplaats.gemeente}`));
      progress.skipped++;
      return;
    }
    ...
    if (begraafplaats.website && !begraafplaats.website.includes('google.com/maps')) {
      try {
        ...
        console.log(chalk.yellow(`\n⚠️  Website scraping failed for ${begraafplaats.naam_begraafplaats}: ${error.message}`));
      }
    }
    ...
    try {
      ...
      console.log(chalk.yellow(`\n⚠️  Google search failed for ${begraafplaats.naam_begraafplaats}: ${error.message}`));
    }
