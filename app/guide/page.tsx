...
export const metadata: Metadata = {
  title: 'Cemetery Guides & Resources | Cemetery Near Me',
  description: 'Expert guides on cemetery types, funeral planning, veterans benefits, green burial options, and famous graves across America. Helpful resources for making informed decisions.',
  keywords: 'cemetery guide, funeral planning, veterans burial, green burial, famous graves, memorial park, cemetery types',
  openGraph: {
    title: 'Cemetery Guides & Resources | Cemetery Near Me',
    description: 'Expert guides on cemetery types, funeral planning, veterans benefits, green burial options, and famous graves across America.',
    type: 'website',
    url: 'https://www.cemeterynearbyme.com/guide',
  },
  alternates: {
    canonical: 'https://www.cemeterynearbyme.com/guide',
  },
};
...
const colorMap: Record<string, { bg: string; text: string; hover: string }> = {
  forest: { bg: 'bg-forest-100', text: 'text-forest-700', hover: 'group-hover:bg-forest-200' },
  gold: { bg: 'bg-gold-100', text: 'text-gold-700', hover: 'group-hover:bg-gold-200' },
...
export default function GuidePage() {
  ...
  const collectionJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Cemetery Guides & Resources',
    description: 'Expert guides on cemetery types, funeral planning, veterans benefits, green burial options, and famous graves across America.',
    url: 'https://www.cemeterynearbyme.com/guide',
    publisher: {
      '@type': 'Organization',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Cemetery Guides
              <span className="block text-gold-300">&amp; Resources</span>
            </h1>
            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Expert guides to help you understand cemetery options, plan meaningful farewells,
              and discover America&apos;s historic burial grounds.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Use our comprehensive directory to search for cemeteries by location, type, or name.
          </p>
