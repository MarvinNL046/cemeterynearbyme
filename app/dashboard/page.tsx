      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your cemetery listings from your dashboard.
          </p>
        </div>
              ...
              {claims.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                    Claim a cemetery listing to manage it and update your information.
                  </p>
                  <Link
                    href="/search"
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <h3 className="font-medium text-gray-900">
                                {slug ? slug.replace(/-/g, ' ').replace(/cemetery /i, '') : `Claim #${claim.id}`}
                              </h3>
            ...
            <div className="bg-white rounded-xl shadow-sm">
              ...
              {favorites.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                    Save cemeteries you have visited or want to remember.
                  </p>
                  <Link
                    href="/search"
                ...
                <div className="divide-y divide-gray-200">
                  {favorites.map((favorite) => (
                    <div key={favorite.id} className="p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <Link
                          href={`/cemetery/${favorite.cemetery_slug}`}
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Claim a cemetery</p>
                  </div>
                </Link>
                <button
