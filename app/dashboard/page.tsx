        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center">
              <span className="text-xl font-bold text-green-700">Begraafplaats</span>
              <span className="text-xl font-bold text-gray-700">InDeBuurt</span>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Beheer je begraafplaats vermeldingen vanaf je dashboard.
          </p>
        </div>
              ...
              {claims.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                    Claim een begraafplaats vermelding om deze te beheren en je gegevens te updaten.
                  </p>
                  <Link
                    href="/zoeken"
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <h3 className="font-medium text-gray-900">
                                {slug ? slug.replace(/-/g, ' ').replace(/begraafplaats /i, '') : `Claim #${claim.id}`}
                              </h3>
            ...
            <div className="bg-white rounded-xl shadow-sm">
              ...
              {favorites.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-500 mb-6 max-w-sm mx-auto">
                    Bewaar begraafplaatsen die u heeft bezocht of wilt onthouden.
                  </p>
                  <Link
                    href="/zoeken"
                ...
                <div className="divide-y divide-gray-200">
                  {favorites.map((favorite) => (
                    <div key={favorite.id} className="p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between">
                        <Link
                          href={`/begraafplaats/${favorite.cemetery_slug}`}
                          className="flex-1 group"
                        >
                          <h3 className="font-medium text-gray-900 group-hover:text-green-600 transition-colors">
                            {favorite.cemetery_name || favorite.cemetery_slug.replace(/-/g, ' ')}
                          </h3>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => handleRemoveFavorite(favorite.cemetery_slug, favorite.id)}
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Claim een begraafplaats</p>
                  </div>
                </Link>
                <button
